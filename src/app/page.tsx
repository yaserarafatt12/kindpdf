    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-6 sm:py-8 space-y-6">
        ...
        <div className="text-center space-y-2 py-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-xs font-black">
              ...
              <button
                ...
                className={`w-full sm:w-auto px-8 py-3.5 rounded-2xl font-black text-sm flex items-center justify-center gap-2 text-white shadow-xl transition-all duration-200 btn-press-effect ${
                  files.length >= 2 && !isProcessing
                    ? 'bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 shadow-indigo-500/30 scale-[1.02]'
      ...
      <footer className="w-full border-t border-slate-200 dark:border-slate-800 py-6 mt-12 text-center text-xs font-semibold text-slate-500 dark:text-slate-400 space-y-1">
        <p>
          Local<span className="text-indigo-600 dark:text-indigo-400 font-extrabold">PDF</span> by edsheero — Privacy-First PDF Tools
        </p>
