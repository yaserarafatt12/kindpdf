    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {!file ? (
        ...
        >
          <button
            type="button"
            className="px-8 py-4 rounded-2xl bg-gradient-to-r from-slate-800 to-slate-900 hover:from-slate-700 hover:to-slate-800 text-white font-black text-base sm:text-lg shadow-lg shadow-slate-900/30 transition-all btn-press-effect flex items-center justify-center gap-2.5"
          >
