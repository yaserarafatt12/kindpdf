    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {!file ? (
        ...
        >
          <button
            type="button"
            className="px-8 py-4 rounded-2xl bg-gradient-to-r from-sky-600 to-cyan-500 hover:from-sky-500 hover:to-cyan-400 text-white font-black text-base sm:text-lg shadow-lg shadow-sky-500/30 transition-all btn-press-effect flex items-center justify-center gap-2.5"
          >
