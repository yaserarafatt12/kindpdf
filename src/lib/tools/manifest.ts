...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Extract selectable text from PDF documents directly in browser.',
    category: 'convert-from',
    status: 'experimental',
    processingMode: 'local',
    popular: false,
    inputFormats: ['.pdf'],
    outputFormats: ['.txt'],
    note: 'Extracts embedded text layers and pattern streams. Scanned images without text layers may require WASM OCR.',
  },
  {
    id: 'pdf-to-pdfa',
    route: 'pdf-to-pdfa',
  ...
  },
  {
    ...
    route: 'unlock',
    title: 'Unlock PDF',
    description: 'Remove password encryption restrictions using valid user key.',
    category: 'security',
    status: 'experimental',
    processingMode: 'local',
    popular: false,
