...
import { UploadCloud, FileText, Lock, AlertCircle } from 'lucide-react';
  ...
  return (
    <div
      ...
      className={`w-full rounded-[28px] border-2 border-dashed p-8 sm:p-12 text-center flex flex-col items-center justify-center gap-4 transition-all duration-300 cursor-pointer ${
        isDragOver
          ? 'border-indigo-600 bg-indigo-500/10 dark:bg-indigo-500/15 scale-[1.01] shadow-xl'
          : 'border-slate-300 dark:border-slate-700 bg-white/60 dark:bg-slate-900/60 hover:border-indigo-500/60 hover:bg-slate-50 dark:hover:bg-slate-800/80 shadow-sm'
    ...
    >
      ...
      <div className="p-4 rounded-3xl bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 shadow-md">
      ...
      <div className="space-y-1.5 max-w-sm">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
          atau <span className="text-indigo-600 dark:text-indigo-400 font-extrabold underline underline-offset-2">Pilih Dokumen dari HP/Komputer</span>
        </p>
      </div>
