    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {!file ? (
        ...
        >
          <button
            type="button"
            className="px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-500 hover:from-purple-500 hover:to-indigo-400 text-white font-black text-base sm:text-lg shadow-lg shadow-purple-500/30 transition-all btn-press-effect flex items-center justify-center gap-2.5"
          >
